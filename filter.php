...
// function change(){
echo color("nevy"," ===================================\n");
echo color("yellow"," Bakar Resto\n");
echo color("green"," TEGAL JAPANESS INDO\n");
...
echo color("nevy"," ===================================\n");
        ...
        echo color("white","\n▬▬▬▬▬▬▬▬▬▬▬▬CLAIM VOUCHER▬▬▬▬▬▬▬▬▬▬▬▬");
        echo "\n".color("white","Bakar Resto..");
        echo "\n".color("white"," Serbuuuu");
        for($a=1;$a<=3;$a++){
        echo color("white",".");
        sleep(35);
        }
	...
	gocar:
        ...
        echo "\n".color("white"," Message: ".$message);
        gofood:
        echo "\n".color("white","BAKAR DRIVERR..");
        echo "\n".color("white"," Kabuurrrr");
        for($a=1;$a<=3;$a++){
        echo color("white",".");
        sleep(0);
        }
